...
from src.constr_lista_cols import contruccion_cols, cols_conteo_servicios_productos, cols_beneficios_presion_economica
...
def lanzar_feat_eng(fecha:str ,n_fe:int , proceso_ppal:str):
    ...
    meses_a_dropear=[201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909]
